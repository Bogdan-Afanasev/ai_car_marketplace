...
const CarDetails = ({ car, testDriveInfo }) => {
  ...
  const [isWislisted, setIsWishlisted] = useState(car.wishlisted);
  ...
  useEffect(() => {
    if (toggleResult?.success && toggleResult.saved !== isWislisted) {
      setIsWishlisted(toggleResult.saved);
      toast.success(toggleResult.message);
    }
  }, [toggleResult, isWislisted]);
    ...
    if (navigator.share) {
      navigator
        .share({
          ...
          text: `Check out this ${car.year} ${car.make} ${car.model} on ACM!`,
      ...
      <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex mt-4 gap-4">
            <Button
              ...
              className={`flex items-center gap-2 flex-1 ${
                isWislisted ? "text-red-500" : ""
              }`}
              onClick={handleSaveCar}
              disabled={savingCar}
            >
              <Heart
                className={`h-5 w-5 ${isWislisted ? "fill-red-500" : ""}`}
              />
        ...
        <div className="w-full lg:w-5/12">
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                <DialogTitle>ACM Car Loan Calculator</DialogTitle>
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-medium">ACM Motors</h4>
