...
CREATE TABLE "DealershipInfo" (
    "id" TEXT NOT NULL,
    "name" TEXT NOT NULL DEFAULT 'ACM Motors',
    "address" TEXT NOT NULL DEFAULT '33 My Street, Novosibirsk, NV 111111',
    "phone" TEXT NOT NULL DEFAULT '+7 (777) 777-7777',
    "email" TEXT NOT NULL DEFAULT 'contact@ACM.com',
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,
